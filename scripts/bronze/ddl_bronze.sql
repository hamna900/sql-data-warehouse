-- This script creates tables in the Bronze schema for CRM and ERP data.  
-- Before creating each table, it first checks if the table already exists.  
-- If it exists, the table is dropped and then recreated.  
